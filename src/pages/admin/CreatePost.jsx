    ...
    <>
      <form className="mx-auto p-4 lg:px-0 lg:py-10 flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
        {image ? (
          ...
          <label ref={fileInput} htmlFor="dropzone-file" className="flex flex-col items-center justify-center h-64 cursor-pointer hover:bg-gray-200 border-2 border-gray-300 border-dashed rounded-lg bg-gray-50">
